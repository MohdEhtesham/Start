...
export default function Signup({navigation}) {
    ...
    const valueset = () => {
        ...
        const info = {name:fullName,email: email,phonenumber:phonenumber, password: Password }
    ...
    return (
        ...
        <SafeAreaView >
            ...
            <ImageBackground
                source={{
                    // uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRud5lylt1aIIYHt5QFtYBdEL0gPm7TbcrcBAo_jEG_WzD5AFTK6QwHw7_vpYmbN0Zhj8E&usqp=CAU'
                }}
                style={{
                    height: "100%",
                    width: "100%",
